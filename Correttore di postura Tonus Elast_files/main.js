(function($) {
    ...
    Landing.prototype.initEvents = function() {
        $('.show-resp').on('click', function() { $('.hidden-resp').slideDown();
            $(this).hide(); });
    ...
    Landing.prototype.initCountDown = function() {
        ...
        var countDownTimer = setInterval(function() {
            ...
            var htmlTime = '   <li> <span class="bold">' + h + '</span> <p></p> </li> <li> <span class="bold">' + m + '</span> <p></p> </li> <li> <span class="mod_c_pink bold">' + s + '</span> <p></p> </li>';
